...
MOTION_THRESHOLD=5000      # Pixel diff threshold to wake from SLEEPING
...
Camera Stream → [State Machine] → IS_PROCESSING / SLEEPING
         ...
         └── Wake on motion > MOTION_THRESHOLD
                 │
                 ▼
...
2. **Crop & Buffer:** Extracts spatial crops for each person and maintains an independent 16-frame queue with 90-frame grace period.
